...
//*************************************网站设置****************************************
    ...
    'ADMIN_EMAIL'               =>  'shenquanwei@gmail.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  '新闻发布平台',             //网站名：
    'WEB_KEYWORDS'              =>  '新闻，发布',         //网站关键字
    'WEB_DESCRIPTION'           =>  '新闻发布平台',      //网站描述
    'AUTHOR'                    =>  'sqwei',               //默认作者
    'COPYRIGHT_WORD'            =>  '本平台新闻版权归原作者所有，如需删除请联系站长。',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  '新闻平台', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'news',      //文字水印内容
...
//***********************************邮箱设置***********************************************
    ...
    'EMAIL_FROM_NAME'           =>  '',      //  发件名
//***********************************评论管理***********************************************
    'COMMENT_REVIEW'            =>  '',       // 评论审核1:开启 0:关闭
    'COMMENT_SEND_EMAIL'        =>  '',   // 被评论邮件通知1:开启 0:关闭
